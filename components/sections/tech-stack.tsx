      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg font-light leading-relaxed">
            Cutting-edge technologies and frameworks powering our exoplanet discovery and analysis system
          </p>
        </div>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-300 leading-relaxed font-light text-base">
                Our advanced exoplanet discovery system integrates state-of-the-art AI frameworks, scalable cloud infrastructure, and modern full-stack development tools. We leverage machine learning for precision pattern recognition, cloud services for elastic scalability, and comprehensive development practices for seamless multi-platform user experiences. This synergistic technology ecosystem enables rapid iteration, robust performance, and cutting-edge exoplanet detection capabilities.
              </p>
            </div>
          </div>
        </div>
